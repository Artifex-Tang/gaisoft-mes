...
import com.gaisoft.common.utils.file.FileTypeUtils;
import com.gaisoft.common.utils.file.FileUtils;
import com.gaisoft.common.utils.file.ImageUtils;
import com.gaisoft.common.utils.poi.ExcelHandlerAdapter;
import com.gaisoft.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
            ...
            for (Object[] os : this.fields) {
                ...
                if (Collection.class.isAssignableFrom(field.getType())) {
                    try {
                        ...
                        int subIndex = 0;
                        for (Object subVo0 : subList) {
                            @SuppressWarnings("unchecked") T subVo = (T) subVo0;
    ...
    private Map<String, CellStyle> annotationDataStyles(Workbook wb) {
        ...
        for (Object[] os : this.fields) {
            ...
            if (Collection.class.isAssignableFrom(field.getType())) {
                ...
                @SuppressWarnings("unchecked") List<Field> subFields = FieldUtils.getFieldsListWithAnnotation((Class)subClass, Excel.class);
    ...
    public void setDataValidation(Excel attr, Row row, int column) {
        ...
        if (StringUtils.isNotEmpty(attr.prompt()) || attr.combo().length > 0 || attr.comboReadDict()) {
            ...
            if (attr.comboReadDict()) {
                ...
                comboArray = StringUtils.split((String)val, (String)",");
            }
    ...
    public static Map<String, PictureData> getSheetPictures07(XSSFSheet sheet, XSSFWorkbook workbook) {
        ...
        for (POIXMLDocumentPart dr : sheet.getRelations()) {
            ...
            @SuppressWarnings("unchecked") List<XSSFShape> shapes = drawing.getShapes();
