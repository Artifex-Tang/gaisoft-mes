...
public class HttpUtils {
    ...
    public static String sendGet(String url, String authorization) {
        return HttpUtils.sendGet(url, "", authorization);
    }

    public static String sendGet(String url, String param, String authorization) {
        return HttpUtils.sendGet(url, param, "UTF-8", authorization);
    }
    ...
    public static String sendPost(String url, String param, String authorization) {
        return HttpUtils.sendPost(url, param, "application/x-www-form-urlencoded", "post", authorization);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static String sendPost(String url, String param, String contentType, String method, String authorization) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static String sendPost1(String url, String param, String contentType) {
        PrintWriter out = null;
        BufferedReader in = null;
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static String sendPostByRag(String url, String authorization, String param, String contentType) {
        PrintWriter out = null;
        BufferedReader in = null;
        StringBuilder result = new StringBuilder();
        try {
            ...
            log.error("调用HttpUtils.sendPost ConnectException, url=" + url, (Throwable)e);
        }
        catch (SocketTimeoutException e) {
            log.error("调用HttpUtils.sendPost SocketTimeoutException, url=" + url, (Throwable)e);
        }
        catch (IOException e) {
            log.error("调用HttpUtils.sendPost IOException, url=" + url, (Throwable)e);
        }
        catch (Exception e) {
            log.error("调用HttpsUtil.sendPost Exception, url=" + url, (Throwable)e);
        }
        finally {
            try {
                if (out != null) {
                ...
                log.error("调用in.close Exception, url=" + url, (Throwable)ex);
            }
        }
        return result.toString();
    }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static String sendDeleteByRag(String url, String authorization, String param, String contentType) {
        PrintWriter out = null;
        BufferedReader in = null;
        StringBuilder result = new StringBuilder();
        try {
