package com.gaisoft.framework.web.domain;

import com.gaisoft.common.utils.Arith;
import com.gaisoft.common.utils.ip.IpUtils;
import com.gaisoft.framework.web.domain.server.Cpu;
import com.gaisoft.framework.web.domain.server.Jvm;
import com.gaisoft.framework.web.domain.server.Mem;
import com.gaisoft.framework.web.domain.server.Sys;
import com.gaisoft.framework.web.domain.server.SysFile;
...
public class Server {
    ...
    private void setSysFiles(OperatingSystem os) {
        ...
        @SuppressWarnings("unchecked") List<OSFileStore> fsArray = fileSystem.getFileStores();
